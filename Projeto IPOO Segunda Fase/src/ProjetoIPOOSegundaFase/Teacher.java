...
public class Teacher {
    ...
    //um caracter nao branco seguido por um caracter nao branco repetido mais 
    //que uma vez vao ser substituidos pelo primeiro caracter nao branco
    private String getInicials(String name){
        return (name.replaceAll("([\\S])([\\S]+)", "$1").replaceAll("\\s", "").toUpperCase());
    }
    
    
    /**This set method is used to choose how the timetable will work. We used a
     * switch so we could allow several options.
     * 
     */
