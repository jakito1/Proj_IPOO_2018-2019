...
/**This class manages the existent classes.
 *
...
public class Classes {
   ...
   /**This method gives us the 3 types of classes students can have. 
    * 
    * @param classType Type; String 
    * @return returns a type of class according to the string. Or null if that
    * string isn't an option.
    */
